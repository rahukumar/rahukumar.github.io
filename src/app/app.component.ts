...
export class AppComponent implements OnInit {
    ...
    // ngAfterViewChecked() {
    //     this.viewDaysOptionChanged(7);
    // }


    getStationsData() {
        this.appService.getStationsData().subscribe(res => {
    ...
    getEvents(e) {
        if (e && e.bookings) {
            ...
            this.appService.getEvents(this.actions, e.bookings)
    ...
    viewDaysOptionChanged(viewDays: number): void {
        ...
        this.calendarScheduler && this.calendarScheduler.setViewDays(viewDays);
    }
