...
export class CalendarSchedulerEventComponent implements OnInit, AfterContentChecked {
    ...
    public ngOnInit(): void {
        this.title = this.title || `${this.event.event.title}, ${this.event.event.content ? `${this.event.event.content},` : null} ${moment(this.event.event.start).format('dddd L, LT')}-${moment(this.event.event.end).format('dddd L, LT')}`;
    }
